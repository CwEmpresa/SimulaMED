  ...
  public: {
    Tables: {
      ...
      usuarios: {
        ...
        // Só `nome` e `onboarding_concluido_em` são graváveis pelo aluno; as
        // demais colunas estão fora do grant de update do papel `authenticated`.
        Update: {
          criado_em?: string
          email?: string
          id?: string
    ...
    Views: {
      /**
       * Gabarito e comentários liberados apenas para o que o usuário já
       * concluiu. As mesmas colunas em `questoes` são inacessíveis ao papel
       * `authenticated` por privilégio de coluna.
       */
      /** tentativas_simulado + prazo calculado com o relógio do Postgres. */
    ...
    Functions: {
      ...
      responder_banco: {
        Args: { p_questao_id: string; p_alternativa: string }
        Returns: {
          acertou: boolean
          resposta_correta: string
          comentario_correta: string | null
