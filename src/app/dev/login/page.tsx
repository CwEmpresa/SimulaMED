 ...
 * protegidas, já que o acesso real é por magic link e depende de caixa de
 * e-mail. A guarda é repetida em três lugares de propósito (página, action e
 * proxy): se qualquer uma falhar sozinha, esta rota vira um bypass de
    ...
    <main className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center gap-6 px-5 py-12">
      <header>
        ...
        <p className="mt-1 text-sm text-texto-suave">
          Atalho para testar telas protegidas sem depender do magic link. Esta rota retorna 404
